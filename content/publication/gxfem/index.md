...
summary: Discretize discontinuous functions on FEM meshes using our generalized XFEM enrichment functions, which support multiple, complex and (self-)intersecting discontinuities.
